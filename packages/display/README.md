...
End-user component for the **Jodit HTML** content element in [Tailor CMS](https://github.com/tailor-cms/author).
...
```sh
npm install @tailor-cms/ce-jodit-html-display
```
...
```ts
import { Display } from '@tailor-cms/ce-jodit-html-display';
```
